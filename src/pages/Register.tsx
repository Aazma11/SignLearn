    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-700 p-12 flex-col justify-center">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl xl:text-5xl font-bold text-white mb-4">Create an Account</h1>
          <p className="text-lg text-white/90 max-w-md">Join ISL Learning to save progress and practice anywhere.</p>
        </div>
      </div>
